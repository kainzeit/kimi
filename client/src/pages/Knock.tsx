          ...
          <div className="max-w-xl text-base leading-loose tracking-wide space-y-5">
            {rawContent.split("\n").map((line: string, idx: number) => {
              ...
              if (line.includes("http")) {
                ...
                if (colonIdx !== -1) {
                  ...
                  return (
                    <p key={idx}>
                      {label}:{" "}
                      <a href={url} target="_blank" rel="noopener noreferrer" style={{ color: "inherit", textDecoration: "underline", textDecorationColor: "#719199", textUnderlineOffset: "5px" }} className="hover:opacity-80 transition">
                        {url}
                      </a>
                    </p>
                  );
              ...
              if (line.includes("@") && !line.includes(" ")) {
                return (
                  <p key={idx}>
                    <a href={`mailto:${line}`} style={{ color: "inherit", textDecoration: "underline", textDecorationColor: "#719199", textUnderlineOffset: "5px" }} className="hover:opacity-80 transition">
                      {line}
                    </a>
                  </p>
                );
